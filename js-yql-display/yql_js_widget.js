...
if (! window.YAHOO){
    document.write('<script type="text/javascript" src="http://yui.yahooapis.com/2.8.0/build/yahoo/yahoo-min.js"></script>' +
                   '<script type="text/javascript" src="http://yui.yahooapis.com/2.8.0/build/get/get-min.js"></script>');
}
...
yqlWidget = function() {
    ...
    ************************************************************/
    var parseFormat = function(node){
        ...
        if (setupConfig['debug'] && window.console){ console.log(currString); }
    ...
    ************************************************************/
    return {
        ...
        getYQLDataCallback: function(o){
            if (setupConfig['debug'] && window.console){ console.log(o.query); }
            if (! o.query){
